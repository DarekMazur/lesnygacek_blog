...
export const StyledMenuListItem = styled.li`
  ...
  width: 40rem;
  color: ${({ theme, social, light }) => (social ? 'default' : light ? theme.colors.white : theme.colors.dark)};
  ...
  &:hover {
    ...
    color: ${({ theme, social, light }) => (social ? 'default' : light ? theme.colors.brown : theme.colors.lightGreen)};
  }
`;
